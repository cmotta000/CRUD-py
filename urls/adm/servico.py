...
def incluir():
    ...
    return render_template('templates/serv/consultar.html', msg="", css_msg="", lst_setores=lst_setores)
...
def salvar_incluir():
    ...
    return render_template('templates/serv/consultar.html', msg=msg, css_msg=css_msg, lst_setores=lst_setores)

@bp_serv.route('/consultar')  # /adm/serv/consultar
def consultar():
   dao_setor = SetorDAO()
   setores = dao_setor.read_by_filters([('sts_setor', '=', 'A')])
   return render_template('templates/serv/consultar.html', servicos=[], setores=setores, filtro_usado='')
...
def roda_consultar():
   ...
   dao_setor = SetorDAO()
   setores = dao_setor.read_by_filters([('sts_setor', '=', 'A')])
   return render_template('templates/serv/consultar.html', servicos=servicos, setores=setores, filtro_usado=filtro_usado)
